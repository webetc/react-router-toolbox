            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    menus.map(function (m) {
                        var haveSideNav = useMenuNav || m.leftSide != null;
                        return React.createElement(Route, { key: m.to, exact: m.exact, path: m.to, render: function render(_ref) {
                                ...
                                return React.createElement(
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement(AppNavDrawerContents, { Component: m.leftSide, menus: menus, showMenus: useMenuNav, match: match })
                                    ),
                                    React.createElement(
                                        AppBar,
                                        {
                                        ...
                                        React.createElement(AppNavContents, { menus: menus, showMenus: useMenuNav })
                                    ),
                                    React.createElement(
                                        Panel,
                                        { bodyScroll: true },
                                        React.createElement(Route, { key: m.to, exact: m.exact, path: m.to, component: m.component })
                                    )
                                );
                            } });
                    })
...
var AppNavDrawerContents = function AppNavDrawerContents(_ref2) {
    ...
    if (Component == null && !showMenus) {
        ...
        return React.createElement(
            List,
            null,
            menus.map(function (m2) {
                return React.createElement(ListItem, { key: m2.title, to: m2.to, caption: m2.title, selectable: true, ripple: true });
            })
        );
    } else {
        return React.createElement(
