...
var AppNavDrawerContents = function AppNavDrawerContents(_ref5) {
    var Component = _ref5.Component,
        ...
        theme = _ref5.theme,
        rest = _objectWithoutProperties(_ref5, ['Component', 'menus', 'showMenus', 'theme']);
    ...
    if (Component == null && !showMenus) {
        ...
        return React.createElement(
            List,
            null,
            filterDrawerMenus(menus).map(function (m2) {
                return React.createElement(ListItemLink, { matchClass: theme.navMatch, key: m2.menu, to: m2.to, caption: m2.menu, selectable: true, ripple: true });
            })
        );
    } else {
        return React.createElement(
    ...
    if (showMenus) {
        ...
        return React.createElement(
            ...
            filterMenus(menus).map(function (m2) {
                return React.createElement(
                    SimpleLink,
                    { matchClass: theme.navMatch, key: m2.menu, to: m2.to },
                    m2.menu
                );
            })
        );
...
function filterMenus(menus) {
    return menus.filter(function (m) {
        return m.appBar != false && m.menu != null && (m.redirect == null || m.redirect() == null);
    });
}
